...
class BoostSerializationPortableBinaryTest : public ::testing::Test {
protected:
  const std::string red = "\033[0;31m";
  const std::string green = "\033[0;32m";
  const std::string reset = "\033[0m";

  BoostSerializationPortableBinaryTest() = default;
  virtual ~BoostSerializationPortableBinaryTest() = default;
};

TEST_F(BoostSerializationPortableBinaryTest, CreateDeletePortableBinaryInArchiveThrowOnEmpty) {
  std::stringstream ss;
  ss << "";
  ASSERT_THROW(boost::archive::portable_binary_iarchive ia{ss}, boost::archive::archive_exception);
}

TEST_F(BoostSerializationPortableBinaryTest, DeserializeThrowOnMissing) {
  {
    std::stringstream ss;
    ss << "{\"bool\":true}";
    ASSERT_THROW(
        {
          boost::archive::portable_binary_iarchive ia{ss};
          bool loaded_o;
...
template <typename T> void stdSerialize(std::string name, T value) {
  ...
  T val = value;
  {
    boost::archive::portable_binary_oarchive oa{ss, boost::archive::no_header};
  ...
  T loaded_o;
  boost::archive::portable_binary_iarchive ia{iss, boost::archive::no_header};
  ia >> boost::make_nvp(name.c_str(), loaded_o);

  EXPECT_EQ(val, loaded_o);
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdBool) { stdSerialize<bool>("bool", true); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdBoolOldArray) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdInt) { stdSerialize<int>("int", -66); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdUIntLowerThanIntMax) { stdSerialize<uint64_t>("uint", uint64_t(66)); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdUInt) { stdSerialize<uint64_t>("uint", uint64_t(ULONG_MAX - 1)); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdDouble) { stdSerialize<double>("double", -666.6); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdString) { stdSerialize<std::string>("string", "Test !!!"); }
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdBoolVector) {
  stdVectorSerialize<bool>("bool_vec", {true, false, true, false});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdBigBoolVector) {
  std::vector<bool> v(1000);
  std::generate(v.begin(), v.end(), []() { return (std::rand() % 2) == 0; });
  stdVectorSerialize<bool>("bool_vec", v);
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdIntVector) { stdVectorSerialize<int>("int_vec", {0, 1, 2, 3}); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdUIntVector) {
  stdVectorSerialize<uint64_t>("uint_vec", {ULONG_MAX, ULONG_MAX - 1, ULONG_MAX - 2, ULONG_MAX - 3});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdDoubleVector) {
  stdVectorSerialize<double>("double_vec", {-123.345, 234.35, 324234.2342, 344.3334});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdStringVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdBoolArray) {
  stdArraySerialize<bool, 4>("bool_array", {true, false, true, false});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdIntArray) { stdArraySerialize<int, 4>("int_array", {0, 1, 2, 3}); }

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdUIntArray) {
  stdArraySerialize<uint64_t, 4>("uint_array", {ULONG_MAX, ULONG_MAX - 1, ULONG_MAX - 2, ULONG_MAX - 3});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdDoubleArray) {
  stdArraySerialize<double, 4>("double_array", {-123.345, 234.35, 324234.2342, 344.3334});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdStringArray) {
  stdArraySerialize<std::string, 4>("string_array", {"true", "false", "true", "false"});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBools) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsArray) {
  stdArraySerialize<BoolsObject, 4>("Booboo_array", {BoolsObject("booboo_0", true, false), BoolsObject("booboo_1", false),
                                                     BoolsObject("booboo_2", true), BoolsObject("booboo_3", false)});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassPtrWithBools) {
  std::stringstream ss;
  ...
  boost::archive::portable_binary_iarchive ia{ss, boost::archive::no_header};
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsPtrVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsPtrArray) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassSptrWithBools) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_StaticSptrWithBools) {
  std::stringstream ss;
  {
    boost::archive::portable_binary_oarchive oa{ss, boost::archive::no_header};
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsSptrVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsUptrVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithBoolsSptrArray) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassPolymorphPtrWithBools) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassPolymorphWithBoolsPtrVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassPolymorphWithBoolsPtrArray) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedBoolsObjects) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassSptrNestedBoolsObjects) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassSptrNestedBoolsObjectsPtr) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedBoolsObjectsVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedBoolsObjectsArray) {
  stdArraySerialize<NestedBoolObjects, 4>("Booboo_array",
                                          {NestedBoolObjects(), NestedBoolObjects(), NestedBoolObjects(), NestedBoolObjects()});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedBoolObjectsPtrs) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedBoolsObjectsPtrsVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedBoolsObjectsPtrsArray) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedPolymorphObjectsPtrs) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedObjectsPtrsVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, NestedObjectsPtrsSptrVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, NestedObjectsPtrsSameSptrVector) {
...
TEST_F(BoostSerializationPortableBinaryTest, NestedObjectsPtrsSameStaticSptrVector) {
  stdVectorSerialize<std::shared_ptr<NestedObjectsPtrs>>("Booboo_static_sptr_vector", {sptr_1, sptr_2, sptr_1, sptr_2});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassNestedObjectsPtrsArray) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdMap_String_Bool) {
  stdMapSerialize<std::string, bool>("string_bool_map", {{"Key_0", true}, {"Key_1", false}, {"Key_2", true}, {"Key_3", false}});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdMap_String_Int) {
  stdMapSerialize<std::string, int>("string_int_map", {{"Key_0", 0}, {"Key_1", 1}, {"Key_2", 2}, {"Key_3", 3}});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdMap_Int_String) {
  stdMapSerialize<int, std::string>("int_string_map", {{0, "Key_0"}, {1, "Key_1"}, {2, "Key_2"}, {3, "Key_3"}});
}

TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdMap_String_BoolsObject) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_StdMap_String_BoolsObjectSptrs) {
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ClassWithObjectPtrsList) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_SptrClassWithUIntList) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_SptrClassWithObjectPtrsList) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ObjectWithEnum) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ObjectSptrWithEnum) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ObjectSptrWithStruct) {
  std::stringstream ss;
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_WeakPtrObject) {
  std::stringstream ss;
  std::shared_ptr<ObjectsPtrsList> booboo = std::make_shared<ObjectsPtrsList>();
...
TEST_F(BoostSerializationPortableBinaryTest, Serialize_ObjectsSptrsWrapper) {
  std::stringstream ss;
...
// TEST_F(BoostSerializationPortableBinaryTest, Serialize_ObjectsSptrsWrappersWithCircularReferences) { FAIL(); }
