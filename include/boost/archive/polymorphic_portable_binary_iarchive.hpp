...
typedef boost::archive::detail::polymorphic_iarchive_route<boost::archive::portable_binary_iarchive>
    polymorphic_portable_binary_iarchive;

#include <boost/version.hpp>
#if BOOST_VERSION > 103401
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(polymorphic_portable_binary_iarchive)
#endif
