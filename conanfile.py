...
class Boost_Json_ArchiveConan(ConanFile):
    name = "boost_portable_binary_archive"
    author = "<Ceber> <contact@cedev.pro>"
    url = "https://github.com/Ceber/boost_portable_binary_archive"
    description = "C++ Boost::boost_portable_binary_archive 2nd party - 'Portable Binary' for boost::serialization."
    ...
    exports_sources = [
        ...
        "LICENSE",
        "CMakeLists.txt",
        "boost_portable_binary_archiveConfig.cmake.in",
    ]
    ...
    def requirements(self):
        ...
        self.options["boost"].without_portable_binary = False
