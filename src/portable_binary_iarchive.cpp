...
void portable_binary_iarchive::init(unsigned int flags) {
  if (0 == (flags & boost::archive::no_header)) {
    ...
    *this >> input_library_version;
    ...
    // detail::
    // #endif
    boost::archive::detail::basic_iarchive::set_library_version(input_library_version);
#endif
  }
  unsigned char x;
  load(x);
...
template class boost::archive::detail::archive_serializer_map<boost::archive::portable_binary_iarchive>;
template class boost::archive::basic_binary_iprimitive<boost::archive::portable_binary_iarchive, std::istream::char_type,
